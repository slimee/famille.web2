            ...
            <v-container v-if="!mailSent">
                ...
                <v-card-text>
                    <v-form v-model="valid" v-on:submit.prevent="validate" ref="form">
                        <v-text-field prepend-icon="mdi-email-outline" type="text" placeholder="quelquun@exemple.com"
                                      label="Adresse e-mail de la personne à inviter"
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn color="primary" @click="validate" :disabled="!valid">Inviter</v-btn>
                </v-card-actions>
            </v-container>
            <v-container v-else>
                <v-card-actions>
